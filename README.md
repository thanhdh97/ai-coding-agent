...
- 🛠️ **`/skills`**: Bộ tiêu chuẩn kỹ thuật chuyên môn chuyên sâu.
  ...
  - **Unit Testing**: Tiêu chuẩn kiểm thử cho [**Vue 3**](./skills/unit-testing) hoặc [**Next.js**](./skills/unit-testing-nextjs).
...
- **Dành cho dự án Next.js:**
  > *"Tôi muốn thực hiện [mục tiêu]. Dự án sử dụng **Next.js**. Hãy đọc và áp dụng triệt để quy tắc trong `.agent/rules/GEMINI.md` cùng các Skill trong thư mục `.agent/skills/` (ưu tiên các bản có đuôi **-nextjs** cho phần Frontend/Testing)."*
