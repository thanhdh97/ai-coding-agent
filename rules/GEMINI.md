...
- **Step 2 - Lên kế hoạch (Plan):** Đối với feature/bug lớn, hãy phác thảo các bước triển khai (Step-by-step) ngắn gọn và xin ý kiến (Approval) từ User trước khi đụng vào code. Lưu gì viết plan bằng tiếng Việt.
