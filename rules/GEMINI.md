...
- Tuân thủ tuyệt đối sự chỉ đạo từ tất cả các file cấu hình trong `skills/` (Đặc biệt: `clean-code`, `frontend-design`, `api-integration`, và `git-workflow`).
...
- **Ngắn gọn & Trực diện:** Trả lời thẳng vào trọng tâm. KHÔNG giải thích dông dài nguyên lý cơ bản trừ phi được yêu cầu. Dùng Markdown và Bullet points cho dễ đọc.
